...
ROLE_DESCRIPTION = {
    ROLE_BUM: "Ты можешь зайти за бутылкой к любому игроку и стать свидетелем убийства.",
    ...
    ROLE_MAFIA: "Твоя задача подчиняться Дону и убивать всех, кто стоит на твоём пути. Однажды ты тоже сможешь стать Доном.",
    ROLE_CITIZEN: "Твоя задача вычислить мафию и на городском собрании линчевать засранцев",
    ROLE_DOCTOR: "Тебе решать кого спасти этой ночью...",
    ROLE_ADVOCATE: "Ночью ты выбираешь кого защищать. Если ты выберешь Мафию, то 🕵️‍ Комиссар Каттани не сможет распознать её и покажет роль 👨🏼 Мирный житель. Твоя задача, чтобы Мафия победила.",
    ROLE_COMMISSAR: "Главный городской защитник и гроза мафии...",
