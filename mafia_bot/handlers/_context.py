...
SETTINGS_ROLE_OPTIONS = [ROLE_COMMISSAR, ROLE_DOCTOR, ROLE_SUICIDE, ROLE_MISTRESS, ROLE_MANIAC, ROLE_BUM, ROLE_SERGEANT, ROLE_ADVOCATE, ROLE_LUCKY, ROLE_KAMIKAZE]
...
SETTINGS_TIMING_LABELS = {"registration": "Регистрация", "night": "Ночь", "day": "День", "vote": "Голосование", "trial": "Подтверждение"}
SETTINGS_TIMING_TITLES = {"registration": "Выберите длительность регистрации (сек.)", "night": "Выберите длительность ночи (сек.)", "day": "Выберите длительность дня (сек.)", "vote": "Выберите длительность голосования (сек.)", "trial": "Выберите длительность подтверждения голосования (сек.)"}
SETTINGS_MUTE_LABELS = {"dead": "Для убитых", "sleeping": "Для спящих", "outsiders": "Для неиграющих"}
SETTINGS_MUTE_TITLES = {"dead": "Требуется ли запрещать убитым писать сообщения в чат?", "sleeping": "Требуется ли запрещать писать сообщения в чат ночью?", "outsiders": "Требуется ли запрещать писать сообщения в чат тем, кто не в игре?"}
...
SETTINGS_MAFIA_RATIO_TITLES = {"high": "Больше (1/3)", "low": "Меньше (1/4)"}
